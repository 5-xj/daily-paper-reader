...
tags: ["query:ahd"]
score: 7.0
evidence: 设计空间探索算法的自动选择机制
tldr: 高级综合（HLS）中的设计空间探索（DSE）因空间巨大而极具挑战，且现有算法在不同基准测试中表现各异，缺乏普适的最优解。本文提出SoberDSE框架，通过学习基准特征来自动推荐最合适的DSE算法。该框架在小样本学习场景下表现优异，显著提升了探索效率和准确性，是实现高效硬件架构搜索的重要进展。
selection_source: fresh_fetch
motivation: 针对现有DSE算法无法在所有硬件设计实例中保持一致领先地位的问题，亟需一种自动化的算法选择机制。
method: 提出SoberDSE框架，利用基于学习的算法选择模型，根据基准测试的特征推荐最优的DSE算法。
result: "实验显示SoberDSE在性能上分别超过现有启发式和学习型方法达5.7倍和4.2倍，且小样本学习准确率平均提升35.57%。"
conclusion: SoberDSE通过智能算法选择有效解决了DSE的效率瓶颈，为复杂硬件设计空间的高效探索提供了新思路。
---

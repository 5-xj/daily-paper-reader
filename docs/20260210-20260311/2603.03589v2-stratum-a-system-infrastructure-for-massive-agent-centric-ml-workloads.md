...
tags: ["query:ahd"]
score: 6.0
evidence: 用于智能体流水线搜索和自动机器学习流水线优化的基础设施
...
motivation: 现有的 Python ML 生态系统主要面向人类交互式工作流，无法高效处理 LLM 智能体在自动化流水线搜索中产生的大规模、高并发且具有高度探索性的任务。
method: Stratum 采用解耦执行与规划的设计，将批量流水线编译为优化的执行图，并利用基于 Rust 的高性能运行时在异构后端上高效执行。
